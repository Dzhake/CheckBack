const PetButtons = [ //Pet crates
  ...
  {name: "Filler 1", name2: "Test", cooldown: 1, cooldownID: 6, unlock: 6},
  {name: "Filler 2", name2: "Test", cooldown: 1, cooldownID: 6, unlock: 6},
  {name: "unboxButton1", name2: "Basic", cooldown: 1, cooldownID: 6, unlock: 6},
  {name: "unboxButton2", name2: "Advanced", cooldown: 3, cooldownID: 7, unlock: 7},
  {name: "unboxButton3", name2: "Epic", cooldown: 5, cooldownID: 8, unlock: 9},
  {name: "unboxButton4", name2: "Legendary", cooldown: 10, cooldownID: 10, unlock: 11},
  {name: "unboxButton5", name2: "Prestige", cooldown: 1, cooldownID: 13, unlock: 14},
  {name: "unboxButton6", name2: "Transcendant", cooldown: 1, cooldownID: 18, unlock: 19},
  {name: "unboxButton7", name2: "Universal", cooldown: 5, cooldownID: 24, unlock: 23},
  {name: "unboxButton8", name2: "Frozen", cooldown: 600, cooldownID: 43, unlock: 28},
]
